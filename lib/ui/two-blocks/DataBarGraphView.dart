...
class DataBarGraphView extends StatelessWidget {
  final String title;
  final Color color;
  final List<num> data;
                ...
                Container(
                  ...
                  child: SfCartesianChart(
                    ...
                    primaryYAxis: NumericAxis(
                      isVisible: false,
                      minimum: aggregated ? max((statistics.min.toDouble() - statistics.standardDeviation.toDouble()), 0) : 0,
